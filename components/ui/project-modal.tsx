            ...
            >
              ...
              <div className="p-6 border-b border-border">
                <div className="flex items-start gap-4">
                  {/* Icon/Logo */}
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-blue-600/20 flex items-center justify-center flex-shrink-0 border border-border shadow-sm">
